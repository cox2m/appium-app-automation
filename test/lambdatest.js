import { promiseRemote } from "wd";

const username = process.env.LT_USERNAME || "mateo.escobar"; //Add username here

const accessKey = process.env.LT_ACCESS_KEY || "sRgAJPwFlAVlEoE08U8QPTql81fFquwOB8viuIKQwjG5nTk7c5"; //Add accessKey here

const desiredCapabilities = {
  "platformName": "android",
	"deviceName": "Galaxy S22 5G",
	"platformVersion": "12",
	"app": "lt://APP10160621161670361076492778",
	"build": "test",
	"name": "test",
	"project": "sc",
	"isRealMobile": true
